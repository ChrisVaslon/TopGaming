            ...
            <ul class="navbar-nav navbar-right">
                <li class="text-light bg-dark">
                    <a class="nav-link"   href="detail-panier">
                        ...
                        <span class="badge bg-secondary text-white rounded-pill"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">${requestScope.qte}</font></font></span>
                    </a></li>
